...
class LineitemsControllerTest < ActionController::TestCase
  ...
  test "should create lineitem" do
    assert_difference('Lineitem.count') do
      post :create, lineitem: { cart_id: @lineitem.cart_id, item_id: @lineitem.item_id, quantity: @lineitem.quantity, shopping_order_id: @lineitem.shopping_order_id }
    end
  ...
  test "should update lineitem" do
    patch :update, id: @lineitem, lineitem: { cart_id: @lineitem.cart_id, item_id: @lineitem.item_id, quantity: @lineitem.quantity, shopping_order_id: @lineitem.shopping_order_id }
    assert_redirected_to lineitem_path(assigns(:lineitem))
  end
