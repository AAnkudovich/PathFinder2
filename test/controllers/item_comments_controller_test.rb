...
class ItemCommentsControllerTest < ActionController::TestCase
  ...
  test "should create item_comment" do
    assert_difference('ItemComment.count') do
      post :create, item_comment: { itemID: @item_comment.itemID, message: @item_comment.message, rating: @item_comment.rating, userID: @item_comment.userID }
    end
  ...
  test "should update item_comment" do
    patch :update, id: @item_comment, item_comment: { itemID: @item_comment.itemID, message: @item_comment.message, rating: @item_comment.rating, userID: @item_comment.userID }
    assert_redirected_to item_comment_path(assigns(:item_comment))
  end
