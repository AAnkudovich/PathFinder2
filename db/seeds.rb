...
# Items for the Shop
Item.create(title: 'Apples',weight: 50.1,price: 49.95,fragile: 0,locationId: 1,boxId: 7,quantity:100,categoryID:2, image:'http://lymanorchards.com/files/7013/6725/1487/apples.jpg')
Item.create(title: 'iMac 21"',weight: 7.2,price: 1800,fragile: 1,locationId: 2,boxId: 6,quantity:100,categoryID:1, image:'http://www.wired.com/wp-content/uploads/2015/10/imac-gallery-13-1024x768.jpg')
Item.create(title: 'MacBook Air 11',weight: 1.8,price: 1229.99,fragile: 1,locationId: 4,boxId: 6,quantity:100,categoryID:1, image:'http://www1.pcmag.com/media/images/427604-apple-macbook-air-11-inch-2014.jpg?thumb=y')
Item.create(title: 'MacBook Air 13',weight: 1.8,price: 1329.99,fragile: 1,locationId: 4,boxId: 6,quantity:100,categoryID:1, image:'http://cdn1.expertreviews.co.uk/sites/expertreviews/files/6/19/macbook_air_11_e_1155_0.jpg?itok=1AENmzF3')
Item.create(title: 'MacBook Pro 13',weight: 2.2,price: 1400,fragile: 1,locationId: 4,boxId: 6,quantity:100,categoryID:1, image:'http://images.electricpig.co.uk/wp-content/uploads/2009/07/mbp-1.jpg')
Item.create(title: 'MacBook Pro 15',weight: 2.2,price: 1600,fragile: 1,locationId: 5,boxId: 6,quantity:100,categoryID:1, image:'http://cdn.thelaptopbulletin.com/wp-content/uploads/2015/06/Macbook_Pro_Retina_diaply_2015_design2.jpg')
Item.create(title: 'Bricks',weight: 50,price: 20,fragile: 0,locationId: 7,boxId: 7,quantity:100,categoryID:3, image:'http://mailbricks.com/wp-content/uploads/2015/01/bricks.jpg')
Item.create(title: 'Pears',weight: 45,price: 49.95,fragile: 0,locationId: 8,boxId: 6,quantity:100,categoryID:2, image:'http://morungexpress.com/wp-content/uploads/2016/04/pears.jpg')
Item.create(title: 'Macbook Air Sleeve',weight: 0.5,price: 29.99,fragile: 0,locationId: 9,boxId: 2,quantity:100,categoryID:4, image:'http://notebooks.wpengine.netdna-cdn.com/wp-content/uploads/2012/06/Lusso-Cartella-MacBook-Air-Sleeve-Review-in-use.jpg')
Item.create(title: 'Macbook Pro Sleeve',weight: 0.5,price: 29.99,fragile: 0,locationId: 10,boxId: 2,quantity:100,categoryID:4, image:'http://media2.popsugar-assets.com/files/2012/07/28/3/192/1922507/381486d5a3ef90a8_Gray_and_Mustard/i/MacBook-Pro-Mustard-Lined-Laptop-Sleeve-36.jpeg')
Item.create(title: 'Macbook Air Screen Protector 11',weight: 0.2,price: 19.99,fragile: 1,locationId: 11,boxId: 2,quantity:100,categoryID:4, image:'http://ecx.images-amazon.com/images/I/31x7SKHY01L.jpg')
Item.create(title: 'Macbook Air Screen Protector 13',weight: 0.2,price: 19.99,fragile: 1,locationId: 12,boxId: 2,quantity:100,categoryID:4, image:'http://ecx.images-amazon.com/images/I/41XmtlASwoL._SL500_AA300_.jpg')
Item.create(title: 'Macbook Pro Screen Protector 13',weight: 0.2,price: 19.99,fragile: 1,locationId: 13,boxId: 2,quantity:100,categoryID:4, image:'http://i.ebayimg.com/00/$(KGrHqV,!lME9knLGn2lBPj872LtWg~~_35.JPG')
Item.create(title: 'Macbook Pro Screen Protector 15',weight: 0.2,price: 19.99,fragile: 1,locationId: 14,boxId: 2,quantity:100,categoryID:4, image:'http://ecx.images-amazon.com/images/I/41Ob-6TGAbL._SY300_.jpg')
Item.create(title: 'iMac 24"',weight: 9,price: 1999.99,fragile: 1,locationId: 15,boxId: 6,quantity:100,categoryID:1, image:'http://www.wired.com/wp-content/uploads/2015/10/imac-gallery-13-1024x768.jpg')
Item.create(title: 'iMac 28"',weight: 11,price: 2199.99,fragile: 1,locationId: 16,boxId: 6,quantity:100,categoryID:1, image:'http://www.wired.com/wp-content/uploads/2015/10/imac-gallery-13-1024x768.jpg')
Item.create(title: 'Cement',weight:50,price:10,fragile: 0,locationId:17 ,boxId:6,quantity:100,categoryID:3, image:'http://www.navanhireanddiy.ie/media/catalog/category/cement_20bag_1.jpg')
Item.create(title: 'Concrete Block',weight:130 ,price:200 ,fragile:0 ,locationId:18 ,boxId:7 ,quantity:100,categoryID:3, image:'https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcT5g-lflTtq9w9wRK_cXDwKGXSqeBZlQA_1WEb_5vwSa-1qDu-6')
Item.create(title: 'Galaxy s7 EDGE',weight: 0.6 ,price: 679 ,fragile: 1,locationId:19 ,boxId:1 ,quantity:100,categoryID:1, image:'http://i1-news.softpedia-static.com/images/news2/samsung-kills-galaxy-s7-edge-plus-following-fans-backlash-500024-2.jpg')
Item.create(title: 'Blender',weight: 3,price: 79.99,fragile: 0,locationId:20 ,boxId: 3,quantity:100,categoryID:5, image:'http://www.atljamaica.com/images/CBLE0KITKSB1570ER.jpg')
Item.create(title: 'Sause Pan',weight: 1,price: 25,fragile: 0,locationId:22 ,boxId: 3,quantity:100,categoryID:5, image:'http://www.beka-cookware.com/assets/products/images/13206144_Suave_Saucepan.jpg')
Item.create(title: 'Frying Pan',weight: 1,price: 20,fragile: 0,locationId:24 ,boxId: 3,quantity:100,categoryID:5, image:'https://www.wmfamericas.com/shop/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/9/1/91.2824.1748.jpg')
Item.create(title: 'Ford Mustang Engine',weight: 300,price: 2500,fragile: 0,locationId:25 ,boxId: 7 ,quantity:100,categoryID:7, image:'https://superchargersonline.files.wordpress.com/2015/08/sm-release-2015-5-0l-mustang-v-3-ver-1.jpg')
Item.create(title: 'Golf MK V Wipers',weight: 1 ,price: 40,fragile: 1,locationId:26 ,boxId: 2 ,quantity:100,categoryID:7, image:'http://3gengagement.dealers.s3.amazonaws.com/baxter-vw/pages-fixed-ops/parts-brochures/wipers/vw-wipers_3.jpg')
Item.create(title: '2006-2009 Passat exhaust',weight: 20 ,price: 199.99 ,fragile: 0,locationId:27 ,boxId: 5 ,quantity:100,categoryID:7, image:'http://cdn1.bigcommerce.com/server5600/aecbb/products/1224/images/1823/30_02_28__27733.1310583836.1280.1280.jpg?c=2')
Item.create(title: 'VW Suspension coil',weight: 3 ,price: 80,fragile: 0 ,locationId:28 ,boxId: 5,quantity:100,categoryID:7, image:'http://assets.suredone.com/1517/media-photos/cp039069-stock-suspension-coil-spring-set-80-91-vw-vanagon-westfalia-camper-genuine.jpg')
Item.create(title: 'DDR3 1Gb RAM Chip',weight: 0.1,price: 35,fragile: 1,locationId:29 ,boxId:1 ,quantity:100,categoryID:8, image:'http://cdn.shopclues.net/images/detailed/1182/ddrram_1378643617.png')
Item.create(title: 'CD/DVD Drive',weight: 2,price: 90 ,fragile: 1,locationId:30 ,boxId:2 ,quantity:100,categoryID:8, image:'https://www.quietpc.com/images/products/lo-dvd-drive-large.jpg')
...
# vans
Van.create(regPlate: '161D1', driverID: 4)
